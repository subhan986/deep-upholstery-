...
export const BookingModal: React.FC<BookingModalProps> = ({ isOpen, onClose, prefilledQuote }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      <div className="relative max-w-lg w-full bg-white rounded-3xl overflow-hidden shadow-2xl p-6 sm:p-8 border border-slate-200 space-y-6 text-left">
        <button
          onClick={onClose}
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-sky-400 via-cyan-500 to-blue-600 hover:from-sky-300 hover:to-blue-500 text-white font-extrabold text-sm tracking-wide shadow-md transition flex items-center justify-center gap-2"
            >
